<template>
    <footer class="p-16 text-white bg-neutral dark:bg-transparent">
        <section class="flex flex-row justify-between w-full">
            ...
            <section class="flex flex-row gap-16">
                ...
                <div class="flex flex-col">
                    ...
                    <NuxtLink class="link link-hover text-sm" to="/tos">Terms and Conditions</NuxtLink>
                    <NuxtLink class="link link-hover text-sm" to="/privacypolicy">Privacy Policy</NuxtLink>
                    <NuxtLink class="link link-hover text-sm" to="/">Cookie Settings</NuxtLink>
                </div>
            </section>

        </section>
        
        <section class="w-full mt-16 text-center text-sm opacity-70 grid grid-cols-3 items-center border-gray-600 border-t pt-8">
            <div class="flex flex-row gap-4">
                <!-- <a 
                    href="https://facebook.com/tattoomii" 
                    target="_blank"
                    class="text-hero transition-colors"
                    aria-label="Facebook"
                >
                ...
                <a 
                    href="https://instagram.com/tattoomii.official" 
                    target="_blank"
                    class="text-hero transition-colors"
                ...
                <!-- <a 
                    href="https://twitter.com/tattoomii" 
                    target="_blank"
                    class="text-hero transition-colors"
                    aria-label="Twitter"
                >
            ...
            <p class="text-center">© 2025 Tattoomi. All rights reserved.</p>
        </section>
    </footer>
</template>